...
export default function HomePage(): JSX.Element {
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-6xl flex-col gap-20 px-6 py-16 sm:px-10 lg:px-12">
      <section className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
        <div className="space-y-6">
          ...
          <p className="max-w-xl text-lg text-neutral-700 sm:text-xl">
            GoalSplit gives groups a single source of truth for contribution schedules, role
            clarity, and progress tracking. No sales pitches—just a calm workspace to align
            on what matters.
          </p>
        ...
        <div className="rounded-3xl border border-primary-100 bg-surface p-8 shadow-lg shadow-primary-100/50">
          <div className="space-y-4 text-sm text-neutral-700">
            ...
            <p className="rounded-2xl bg-primary-50 p-4 text-primary-800">
              Everyone sees the same plan, updates, and progress. GoalSplit keeps communication
      ...
      <section id="features" className="space-y-10">
        <div className="space-y-4">
          ...
          <p className="max-w-2xl text-lg text-neutral-700">
            Align on shared outcomes with structured updates, predictable growth forecasts, and
        ...
        <div className="grid gap-8 md:grid-cols-3">
          {highlights.map((highlight) => (
            <article
              key={highlight.title}
              className="flex flex-col gap-3 rounded-2xl border border-neutral-200/80 bg-white p-6 shadow-sm"
            >
      ...
      <section
        id="insights"
        className="rounded-3xl bg-neutral-900 px-8 py-12 text-neutral-100 shadow-xl"
      >
        <div className="space-y-6">
          <h2 className="font-display text-3xl font-semibold sm:text-4xl">
            Transparent insights for every contributor
          </h2>
          <p className="max-w-3xl text-lg text-neutral-200">
            Generate shared summaries, commitments, and timelines that keep everyone informed.
            GoalSplit highlights variances early and provides calm nudges—never unsolicited
            offers—so teams can adjust together.
          </p>
          <div className="grid gap-6 md:grid-cols-3">
            <div className="rounded-2xl bg-neutral-800/70 p-6 shadow-inner">
              ...
              <p className="mt-2 text-lg text-neutral-100">
                Capture notes from planning sessions and publish next steps instantly.
              </p>
            </div>
            <div className="rounded-2xl bg-neutral-800/70 p-6 shadow-inner">
              <p className="text-sm uppercase tracking-wide text-primary-200">Fixed Returns</p>
              <p className="mt-2 text-lg text-neutral-100">
                Keep the focus on predictable schedules so contributors know exactly what to
                expect.
              </p>
            </div>
            <div className="rounded-2xl bg-neutral-800/70 p-6 shadow-inner">
              ...
              <p className="mt-2 text-lg text-neutral-100">
                Celebrate milestones together with updates that spotlight collective progress.
              </p>
            </div>
          </div>
        </div>
