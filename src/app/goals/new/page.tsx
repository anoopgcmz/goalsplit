            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  />
                  {showError("title") ? (
                    <p id="goal-title-error" className="text-sm text-red-600">
                      {errors.title}
                    </p>
                  ) : null}
                </div>
                ...
                <div className="grid gap-4 sm:grid-cols-[2fr,1fr]">
                  <div className="space-y-2">
                    ...
                    {showError("targetAmount") ? (
                      <p id="target-amount-error" className="text-sm text-red-600">
                        {errors.targetAmount}
                      </p>
                    ) : null}
                  </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-2">
                ...
                {showError("targetDate") ? (
                  <p id="target-date-error" className="text-sm text-red-600">
                    {errors.targetDate}
                  </p>
                ) : null}
              </CardContent>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  {showError("expectedReturn") ? (
                    <p id="expected-return-error" className="text-sm text-red-600">
            ...
            <Card>
              ...
              <CardContent className="space-y-2">
                ...
                {showError("existingSavings") ? (
                  <p id="existing-savings-error" className="text-sm text-red-600">
